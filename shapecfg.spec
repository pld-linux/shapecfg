...
Program shapecfg konfiguruje ograniczenia przepustowości sieci. Aby
używać tego pakietu trzeba mieć jądro z modułem ograniczania
przepustowości - jest dostępny od wersji 2.0.36 lub późnych 2.1.x.
